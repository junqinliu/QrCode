 ...
 */
public class SubOwnerApplyManageAdapter extends BaseAdapter {

    Context context;
    List<SubOwnerApplyManageBean> list;

    public SubOwnerApplyManageAdapter(Context context, List<SubOwnerApplyManageBean> list) {
