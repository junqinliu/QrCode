 ...
 */
public class SubOwnerApplyManageActivity extends BaseAppCompatActivity implements  SwipeRefreshLayout.OnRefreshListener, AbsListView.OnScrollListener,
    ...
    SubOwnerApplyManageAdapter ownerApplyManageAdapter;
    private List<SubOwnerApplyManageBean> ownerApplyManageBeanList = new ArrayList<>();
    private List<SubOwnerApplyManageBean> ownerApplyManageBeanListTemp = new ArrayList<>();
    ...
    public void initData() {
        ...
        ownerApplyManageAdapter = new SubOwnerApplyManageAdapter(this, ownerApplyManageBeanList);
    ...
    public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
        ...
        new AlertDialog.Builder(SubOwnerApplyManageActivity.this, AlertDialog.THEME_HOLO_LIGHT).setTitle("提示")
                .setMessage("是否认证？")
    ...
    private void getList(){
        ...
        HttpUtil.get(Constants.HOST + Constants.isROOT, params, new AsyncHttpResponseHandler() {
            ...
            public void onStart() {
                super.onStart();
                if (!NetUtil.checkNetInfo(SubOwnerApplyManageActivity.this)) {
                    ...
                    try {
                        ...
                        if (jsonObject != null) {
                            ...
                            if (jsonObject.getBoolean("success")) {
                                ...
                                ownerApplyManageBeanListTemp = JSON.parseArray(gg.getJSONArray("items").toString(), SubOwnerApplyManageBean.class);
   ...
   private void rootAction(String auditstatus){
       ...
       HttpUtil.post(SubOwnerApplyManageActivity.this, Constants.HOST + Constants.ROOT, entity, "application/json", new AsyncHttpResponseHandler() {
           @Override
           public void onStart() {
               super.onStart();
               if (!NetUtil.checkNetInfo(SubOwnerApplyManageActivity.this)) {
