package com.android.qrcode.Address;
...
import com.android.mylibrary.model.KeySearchCommunityBean;
    ...
    public void setListener() {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> arg0, View arg1, int arg2, long arg3) {
                ...
                intent.putExtra("province",list.get(arg2).getProvincename());
                intent.putExtra("city",list.get(arg2).getCityname());
                intent.putExtra("zone",list.get(arg2).getAreaname());
                intent.putExtra("houseid",list.get(arg2).getHouseid());
                intent.putExtra("housename",list.get(arg2).getName());
