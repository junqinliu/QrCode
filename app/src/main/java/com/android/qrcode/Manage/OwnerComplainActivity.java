 ...
 */
public class OwnerComplainActivity extends BaseAppCompatActivity implements  SwipeRefreshLayout.OnRefreshListener, AbsListView.OnScrollListener,
    ...
    public void initView() {
        ...
        toolBar.setTitle("");
        toolbar_title.setText(R.string.complain);
